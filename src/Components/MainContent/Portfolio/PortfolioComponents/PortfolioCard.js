...
const PortfolioCard = ({ data }) => {
  return (
    <div className="mt-12">
      <div className="portfolio-card cursor-pointer  w-full h-full rounded-2xl p-8">
        <div className="w-full h-64 img-hover-zoom relative ">
          <img
            className="rounded-2xl absolute w-full h-full portfolio-img"
            src={data.Image}
            alt=""
          />
        </div>
        ...
        <div className="mt-6 flex justify-between items-center">
          ...
          <span className="text-xs font-medium text-[#878e99] ">
            <i class="far fa-heart"></i> {data.Like}
          </span>
        </div>
